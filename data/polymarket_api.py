...
class PolymarketAPI:
    def __init__(self):
        ...
        self.min_interval     = 1  # turunkan dari 2 ke 1 detik
    ...
    def get_markets(self, limit: int = 50) -> List[Dict]:  # default naik ke 50
        ...
        try:
            ...
            for m in markets:
                ...
                # Ambil volume — coba beberapa field yang mungkin ada
                volume = float(
                    m.get('volume') or
                    m.get('volumeNum') or
                    m.get('usdcLiquidity') or
                    0
                )
            ...
            print(f"   📡 Fetched {len(formatted)} markets from Polymarket")
            return formatted
